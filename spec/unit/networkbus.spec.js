...
import NetworkBus, {APIURL, VERSION} from 'views/classes/networkbus.js'
import AllTrends, {AllTrendsTrend} from 'views/types/alltrends.js'
...
describe('NetworkBus', function () {
  ...
  it('parses /v1/trend/{name}/articles?limit', function (done) {
    const someTrend = 'Jerusalem'
    const someResponse = {
      articles: [{
        _id: '0',
